...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, STT0_Pin|STT1_Pin|STT2_Pin|STT3_Pin
                          |STATUS_LED_Pin|EN0_Pin|EN1_Pin|EN2_Pin
  ...
  /*Configure GPIO pins : STT0_Pin STT1_Pin STT2_Pin STT3_Pin
                           STATUS_LED_Pin EN0_Pin EN1_Pin EN2_Pin
                           EN3_Pin */
  GPIO_InitStruct.Pin = STT0_Pin|STT1_Pin|STT2_Pin|STT3_Pin
                          |STATUS_LED_Pin|EN0_Pin|EN1_Pin|EN2_Pin
                          |EN3_Pin;
