...
/* Private defines -----------------------------------------------------------*/
#define STT0_Pin GPIO_PIN_1
#define STT0_GPIO_Port GPIOA
#define STT1_Pin GPIO_PIN_2
#define STT1_GPIO_Port GPIOA
#define STT2_Pin GPIO_PIN_3
#define STT2_GPIO_Port GPIOA
#define STT3_Pin GPIO_PIN_4
#define STT3_GPIO_Port GPIOA
...
#define AMBER0_Pin GPIO_PIN_9
#define AMBER0_GPIO_Port GPIOB
